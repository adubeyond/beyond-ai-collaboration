...
[安装、升级与项目初始化](模板交付包/docs/安装升级与项目初始化指南.md) · [快速开始](docs/快速开始.md) · [v3.2.2升级说明](docs/releases/v3.2.2.md) · [系统架构](docs/系统架构与运行机制.md) · [控制仓交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前正式版本为`v3.2.2`。它为暂停恢复增加短期终态回执，并让当前明确指令优先于BEYOND默认偏好，在保留权限边界的同时收短普通任务执行路径。
