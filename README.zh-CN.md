...
[快速开始](docs/快速开始.md) · [v3.0.9升级说明](docs/releases/v3.0.9.md) · [系统架构](docs/系统架构与运行机制.md) · [模板交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前版本为`v3.0.9`。`v3.0.2`已经废弃且从未进入公开主线；v3.0.9不增加身份、状态或审批，重点固定正式Worker创建、终态回源、PM退出和新Worker模型选择路径。
