...
[安装、升级与项目初始化](模板交付包/docs/安装升级与项目初始化指南.md) · [快速开始](docs/快速开始.md) · [v3.1.5升级说明](docs/releases/v3.1.5.md) · [系统架构](docs/系统架构与运行机制.md) · [控制仓交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前正式版本为`v3.1.5`。它保留无Hook运行主链，避免Worker结果打断PM正在生成的回答，并把新Worker模型选择收敛为项目级、可展示、可验证的固定路径。
