...
[安装、升级与项目初始化](模板交付包/docs/安装升级与项目初始化指南.md) · [快速开始](docs/快速开始.md) · [v3.2.1升级说明](docs/releases/v3.2.1.md) · [系统架构](docs/系统架构与运行机制.md) · [控制仓交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前正式版本为`v3.2.1`。它以Worker正式final为任务结果真值，把原生轻量唤醒固定为Worker最后一次工具调用，并阻止测试缓存和本机备份在项目接入时被递归复制。
