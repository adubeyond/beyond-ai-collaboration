...
[快速开始](docs/快速开始.md) · [v3.0.7升级说明](docs/releases/v3.0.7.md) · [系统架构](docs/系统架构与运行机制.md) · [模板交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前公开版本为`v3.0.7`。`v3.0.2`已经废弃且从未进入公开主线；v3.0.7保留3.0.5的短执行路径，修复3.0.6实战暴露的任务容器与连续推进问题，并增加有证据支撑的模型选择和范围膨胀刹车。
