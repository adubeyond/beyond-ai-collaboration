...
[快速开始](docs/快速开始.md) · [v3.0.8升级说明](docs/releases/v3.0.8.md) · [系统架构](docs/系统架构与运行机制.md) · [模板交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前公开版本为`v3.0.8`。`v3.0.2`已经废弃且从未进入公开主线；v3.0.8保留3.0.7的连续执行能力，并修复混合版本误判、PM模型越权和接手项目误启动旧任务。
