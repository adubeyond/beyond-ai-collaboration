...
[快速开始](docs/快速开始.md) · [v3.0.3升级说明](docs/releases/v3.0.3.md) · [系统架构](docs/系统架构与运行机制.md) · [模板交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前版本为`v3.0.3`，重建了“根入口 → PM → 执行者 → 动作 Skill”的真实运行链，强化任务、证据和历史回收边界，并继续如实保留下文所列的安装与平台限制。`v3.0.2`未在主线打标签或正式发布。完整变化见[v3.0.1 → v3.0.3升级说明](docs/releases/v3.0.3.md)。
