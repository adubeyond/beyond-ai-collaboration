...
[快速开始](docs/快速开始.md) · [v3.1.1升级说明](docs/releases/v3.1.1.md) · [系统架构](docs/系统架构与运行机制.md) · [控制仓交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前版本为`v3.1.1`。它保留v3.1.0的团队协同与控制仓能力，修复Hook信任假成功、老项目正式文档漏读、旧工作台静默丢失、多仓歧义和入口备份换行漂移。
