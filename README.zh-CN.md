...
请使用我已下载并验真通过的BEYOND 3.2.2正式发布包，安装或升级当前项目的beyond-control和六个全局Skill。
...
BEYOND 3.2.2不安装身份Hook、notify分支、守护进程或额外Codex CLI。
...
- 当前正式版本是`v3.2.2`，主要面向Codex Desktop本地项目。
...
| 查看3.2.2变化 | [升级说明](docs/releases/v3.2.2.md) · [CHANGELOG](CHANGELOG.md) |
