...
[快速开始](docs/快速开始.md) · [v3.0.4升级说明](docs/releases/v3.0.4.md) · [v3.0.5升级说明](docs/releases/v3.0.5.md) · [系统架构](docs/系统架构与运行机制.md) · [模板交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前公开版本为`v3.0.5`。`v3.0.2`已经废弃且从未进入公开主线；v3.0.5移除会夺走任务控制权的固定方法流程，并保留v3.0.4已经形成的生产级授权、证据、Git和回滚能力。
