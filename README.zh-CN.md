...
[安装、升级与项目初始化](模板交付包/docs/安装升级与项目初始化指南.md) · [快速开始](docs/快速开始.md) · [v3.1.6升级说明](docs/releases/v3.1.6.md) · [系统架构](docs/系统架构与运行机制.md) · [控制仓交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前正式版本为`v3.1.6`。它保留无Hook运行主链，并把最低接入后的完整初始化或按需补齐收敛为可恢复、可验真的固定路径。
