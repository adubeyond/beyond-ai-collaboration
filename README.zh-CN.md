...
[安装、升级与项目初始化](模板交付包/docs/安装升级与项目初始化指南.md) · [快速开始](docs/快速开始.md) · [v3.1.4升级说明](docs/releases/v3.1.4.md) · [系统架构](docs/系统架构与运行机制.md) · [控制仓交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前源码候选为`v3.1.4`。它保留v3.1.3的无Hook运行主链，并修正快速开始中残留的强制重启和旧身份护栏表述。
