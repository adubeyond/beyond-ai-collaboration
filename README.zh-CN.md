...
[安装、升级与项目初始化](模板交付包/docs/安装升级与项目初始化指南.md) · [快速开始](docs/快速开始.md) · [v3.1.7升级说明](docs/releases/v3.1.7.md) · [系统架构](docs/系统架构与运行机制.md) · [控制仓交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前正式版本为`v3.1.7`。它保留v3.1.6的项目初始化闭环，恢复平台终态主链，避免PM被插入打断，并补回可靠的重启生效边界。
