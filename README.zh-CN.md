...
[安装、升级与项目初始化](模板交付包/docs/安装升级与项目初始化指南.md) · [快速开始](docs/快速开始.md) · [v3.1.3升级说明](docs/releases/v3.1.3.md) · [系统架构](docs/系统架构与运行机制.md) · [控制仓交付包](模板交付包) · [参与贡献](CONTRIBUTING.md)

> 当前源码候选为`v3.1.3`。它保留v3.1.2的项目内默认控制仓，移除默认运行链对 Hook 信任、探针和重启的依赖；PM 与 Worker 继续由显式 Skill、用户可见任务和来源关系确定。
